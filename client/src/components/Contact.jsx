    ...
    >
        <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
            ...
            <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                <h2 className='headline-2 lg:max-w-[12ch] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 via-purple-600 to-indigo-700  drop-shadow'>
        ...
        <hr className='mt-12 h-[0.5px] border-gray-600 '></hr>
    </section>
